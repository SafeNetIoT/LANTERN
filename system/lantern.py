...
if __name__ == "__main__":
    ...
    parser.add_argument("--end", type=str, default="2025-04-30", help="End date (YYYY-MM-DD)")
    parser.add_argument("--days", type=int, default=30, help="Window length in days (default=8)")
    parser.add_argument("--out", type=str, default="../data/res/memorytest/h30/output_anchor.csv", help="Output CSV path")
